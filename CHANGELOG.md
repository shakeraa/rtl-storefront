...
- Optimize translation-memory and glossary query paths by batching import lookups, using grouped stats queries, and collapsing translation search to a single candidate fetch.
