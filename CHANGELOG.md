...
- Add disaster-recovery configuration helpers with validation for backup cadence, retention, and notification email.
...
- Add brand-term extraction helpers so recurring source terminology can be promoted into never-translate protection rules.
