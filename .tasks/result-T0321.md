...
- 21 materials with full localization:
  - **Natural**: cotton (قطن/כותנה), silk (حرير/משי), leather (جلד/עור), wool (صوف/צמר), linen (كتان/פשתן), cashmere (كشمير/קשמיר), suede (شمواه/זמש), mohair (موهير/מוהר)
...
## Test Results
```
✓ test/unit/material-localization.test.ts (38 tests) 18ms
