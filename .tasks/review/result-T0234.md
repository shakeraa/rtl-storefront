...
Implemented course-app content translation helpers for course titles, module names, lesson summaries, and enrollment labels in `app/services/integrations/index.ts`. Added integration tests covering translated course structures and metadata preservation in `test/unit/integrations.test.ts`. Updated `CHANGELOG.md` with the new integration support and resolved the existing conflict markers in the Unreleased section on this branch.
...
> vitest run integrations
 ...
 RUN  v3.0.9 /Users/shaker/shopify-dev/rtl-storefront-codex-t0234
 ...
 Test Files  1 passed (1)
      Tests  10 passed (10)
   Start at  16:59:43
   Duration  1.39s (transform 43ms, setup 58ms, collect 41ms, tests 4ms, environment 561ms, prepare 65ms)
```
