...
Implemented tax-app translation helpers for tax settings titles, tax labels, summaries, and exemption messaging in `app/services/integrations/index.ts`. Added integration tests covering translated tax content and metadata preservation in `test/unit/integrations.test.ts`. Updated `CHANGELOG.md` with the new integration support and resolved the existing conflict markers in the Unreleased section on this branch.
...
> vitest run integrations
 ...
 RUN  v3.0.9 /Users/shaker/shopify-dev/rtl-storefront-codex-t0244
 ...
 Test Files  1 passed (1)
      Tests  10 passed (10)
   Start at  17:27:18
   Duration  1.36s (transform 68ms, setup 71ms, collect 19ms, tests 4ms, environment 650ms, prepare 221ms)
```
