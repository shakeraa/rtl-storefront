...
Implemented invoice-app translation helpers for invoice titles, payment labels, billing summaries, and invoice line items in `app/services/integrations/index.ts`. Added integration tests covering translated invoice content and metadata preservation in `test/unit/integrations.test.ts`. Updated `CHANGELOG.md` with the new integration support and resolved the existing conflict markers in the Unreleased section on this branch.
...
> vitest run integrations
 ...
 RUN  v3.0.9 /Users/shaker/shopify-dev/rtl-storefront-codex-t0243
 ...
 Test Files  1 passed (1)
      Tests  10 passed (10)
   Start at  17:25:10
   Duration  1.42s (transform 45ms, setup 57ms, collect 21ms, tests 4ms, environment 656ms, prepare 136ms)
```
