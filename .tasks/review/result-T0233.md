...
Implemented event-app content translation helpers for event titles, venue labels, agenda items, and call-to-action text in `app/services/integrations/index.ts`. Added integration tests covering translated event fields and metadata preservation in `test/unit/integrations.test.ts`. Updated `CHANGELOG.md` with the new integration support and resolved the existing conflict markers in the Unreleased section on this branch.
...
> vitest run integrations
 ...
 RUN  v3.0.9 /Users/shaker/shopify-dev/rtl-storefront-codex-t0233
 ...
 Test Files  1 passed (1)
      Tests  10 passed (10)
   Start at  16:56:50
   Duration  1.29s (transform 62ms, setup 57ms, collect 20ms, tests 3ms, environment 602ms, prepare 134ms)
```
