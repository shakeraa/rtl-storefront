...
export const FASHION_DATABASE: FashionDBEntry[] = [
  ...
  },
  {
    ...
    category: "accessories",
    subcategory: "hijab",
    dialects: { egyptian: "توربان", maghrebi: "توربان" },
  ...
  },
  {
    ...
    searchTerms: ["khaleeji kaftan", "daraa", "قفטان خليجي", "دراعة"],
  ...
  },
  {
    ...
    category: "traditional_wear",
    subcategory: "kaftan",
    dialects: { maghrebi: "قفطان العروسة" },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // ADDITIONAL TERMS (merged from fashion-corpus)
  // ═══════════════════════════════════════════════════════════════════════════
  {
    id: "sirwal",
    english: "Sirwal",
    ...
    hebrew: "סרוואל",
    category: "traditional_wear",
    description: "Traditional loose trousers",
    searchTerms: ["sirwal", "سروال", "loose trousers"],
    imageKeywords: ["sirwal", "traditional pants"],
  },
  {
    id: "farwa",
    english: "Farwa",
    ...
    hebrew: "פרווה",
    category: "traditional_wear",
    description: "Traditional fur-lined cloak",
    searchTerms: ["farwa", "فروة", "fur cloak"],
    imageKeywords: ["farwa", "traditional cloak"],
  },
  {
    id: "taqiyah",
    english: "Taqiyah",
    ...
    description: "Rounded skullcap",
    searchTerms: ["taqiyah", "طاقية", "skullcap", "kufi"],
    imageKeywords: ["taqiyah", "prayer cap"],
  },
  {
    id: "agal",
    english: "Agal",
    ...
    subcategory: "headwear",
    dialects: { gulf: "عقال" },
    description: "Black cord holding the ghutra in place",
    searchTerms: ["agal", "عقال", "igal", "headband cord"],
    imageKeywords: ["agal", "ghutra cord"],
  },
  {
    id: "burqa-covering",
    english: "Burqa",
    ...
    category: "accessories",
    subcategory: "veil",
    description: "Full face covering",
    searchTerms: ["burqa", "برقع", "full covering"],
    imageKeywords: ["burqa", "full veil"],
  },
  {
    id: "long-sleeve",
    english: "Long Sleeve",
    ...
    hebrew: "שרוול ארוך",
    category: "modest_fashion",
    description: "Garment with full-length sleeves for modesty",
    searchTerms: ["long sleeve", "أكمام طويلة", "full sleeve"],
    imageKeywords: ["long sleeve", "modest sleeve"],
  },
  {
    id: "full-length",
    english: "Full-Length",
    ...
    hebrew: "אורך מלא",
    category: "modest_fashion",
    description: "Floor-length or ankle-length garment",
    searchTerms: ["full-length", "طول كامل", "floor length", "maxi"],
    imageKeywords: ["full length dress", "maxi length"],
  },
  {
    id: "loose-fit",
    english: "Loose-Fit",
    ...
    hebrew: "גזרה רחבה",
    category: "modest_fashion",
    description: "Relaxed, non-form-fitting silhouette",
    searchTerms: ["loose-fit", "قصة واسعة", "relaxed fit", "oversized"],
    imageKeywords: ["loose fit", "relaxed silhouette"],
  },
  {
    id: "maxi-dress",
    english: "Maxi Dress",
    ...
    hebrew: "שמלת מקסי",
    category: "modest_fashion",
    description: "Full-length dress suitable for modest wear",
    searchTerms: ["maxi dress", "فستان طويل", "long dress"],
    imageKeywords: ["maxi dress", "long modest dress"],
  },
  {
    id: "tunic",
    english: "Tunic",
    ...
    hebrew: "טוניקה",
    category: "modest_fashion",
    description: "Long top or short dress reaching mid-thigh or below",
    searchTerms: ["tunic", "تونيك", "long top"],
    imageKeywords: ["tunic", "modest top"],
  },
  {
    id: "wide-leg-pants",
    english: "Wide-Leg Pants",
    arabic: "بنطلون واسع",
    hebrew: "מכנסיים רחבים",
    category: "modest_fashion",
    description: "Loose-fitting wide-leg trousers for modest wear",
    searchTerms: ["wide-leg pants", "بنطلون واسع", "palazzo pants"],
    imageKeywords: ["wide leg pants", "palazzo"],
  },
  {
    id: "streetwear",
    english: "Streetwear",
    ...
    hebrew: "אופנת רחוב",
    category: "modern_fusion",
    description: "Casual urban fashion style",
    searchTerms: ["streetwear", "أزياء الشارع", "urban fashion"],
    imageKeywords: ["streetwear", "urban style"],
  },
  {
    id: "athleisure",
    english: "Athleisure",
    arabic: "أزياء رياضية عصرية",
    hebrew: "אתלז'ר",
    category: "modern_fusion",
    description: "Athletic-inspired casual wear",
    searchTerms: ["athleisure", "أزياء رياضية عصرية", "sporty casual"],
    imageKeywords: ["athleisure", "sporty fashion"],
  },
  {
    id: "couture",
    english: "Couture",
    ...
    hebrew: "הוט קוטור",
    category: "modern_fusion",
    description: "High-end custom-made fashion",
    searchTerms: ["couture", "أزياء راقية", "haute couture", "high fashion"],
    imageKeywords: ["couture", "haute couture", "luxury fashion"],
  },
  {
    id: "ready-to-wear",
    ...
    hebrew: "פרט-א-פורטה",
    category: "modern_fusion",
    description: "Factory-made clothing in standard sizes",
    searchTerms: ["ready-to-wear", "ملابس جاهزة", "pret-a-porter"],
    imageKeywords: ["ready to wear", "off the rack"],
  },
  {
    id: "resort-wear",
    english: "Resort Wear",
    arabic: "أزياء المنتجعات",
    hebrew: "אופנת נופש",
    category: "modern_fusion",
    description: "Vacation and resort-style clothing",
    searchTerms: ["resort wear", "أزياء المنتجعات", "vacation wear", "cruise wear"],
    imageKeywords: ["resort wear", "vacation fashion"],
  },
  {
    id: "capsule-collection",
    english: "Capsule Collection",
    arabic: "مجموعة كبسولة",
    hebrew: "קולקציית קפסולה",
    category: "modern_fusion",
    description: "Small, curated collection of interchangeable pieces",
    searchTerms: ["capsule collection", "مجموعة كبسولة", "capsule wardrobe"],
    imageKeywords: ["capsule collection", "curated wardrobe"],
  },
];
...
/**
 * Normalize search text by removing diacritics and special characters
 */
...
/**
 * Get localized term based on locale
 */
...
/**
 * Get a fashion term by its ID in the specified locale.
...
/**
 * Fuzzy-search across english, arabic, hebrew and searchTerms fields.
...
export function searchFashionTerms(
  ...
  for (const entry of FASHION_DATABASE) {
    ...
    // Exact match in localized language - highest score
    if (localizedTerm === normalizedQuery) {
      score = 100;
    }
    // Starts with query in localized language
    else if (localizedTerm.startsWith(normalizedQuery)) {
      score = 80;
    }
    // Contains query in localized language
    ...
    // Match in Arabic (for cross-language search)
    else if (arabicTerm.includes(normalizedQuery)) {
      score = 25;
    }
    // Match in Hebrew (for cross-language search)
...
/**
 * Get all fashion categories with localized names.
 */
...
/**
 * Get the Arabic translation for a given English fashion term.
 * If a dialect is specified and the entry has a dialect variant, return that instead.
 * @deprecated Use getFashionTerm() instead for full locale support
 */
export function getArabicTranslation(
  ...
  const entry = FASHION_DATABASE.find((e) => e.english.toLowerCase() === lowerEnglish);
  if (!entry) return null;
...
/**
 * Get all entries belonging to a specific category.
 * @deprecated Use getTermsByCategory() instead for full locale support
 */
...
/**
 * Get all terms as a flat array (for data export or bulk operations).
 */
export function getAllTerms(): FashionDBEntry[] {
  return [...FASHION_DATABASE];
}

/**
 * Get total count of fashion terms in the database.
 */
