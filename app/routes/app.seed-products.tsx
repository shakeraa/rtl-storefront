/**
 * Seed Rich Content Products Route
 * 
 * This route creates multiple products with rich content for testing the RTL Storefront app.
 * Access this at: /app/seed-products
 */
...
<p><em>"This abaya combines traditional values with contemporary fashion. Perfect for Ramadan and Eid."</em></p>`,
    ...
    options: ["Size", "Color"],
    variants: [
      { options: ["S", "Black"], price: "189.00", sku: "ABY-EMB-BLK-S", inventoryQuantity: 15 },
      { options: ["M", "Black"], price: "189.00", sku: "ABY-EMB-BLK-M", inventoryQuantity: 20 },
      { options: ["L", "Black"], price: "189.00", sku: "ABY-EMB-BLK-L", inventoryQuantity: 18 },
      { options: ["XL", "Black"], price: "189.00", sku: "ABY-EMB-BLK-XL", inventoryQuantity: 12 },
      { options: ["S", "Navy Blue"], price: "189.00", sku: "ABY-EMB-NVY-S", inventoryQuantity: 10 },
      { options: ["M", "Navy Blue"], price: "189.00", sku: "ABY-EMB-NVY-M", inventoryQuantity: 14 },
      { options: ["L", "Navy Blue"], price: "189.00", sku: "ABY-EMB-NVY-L", inventoryQuantity: 11 },
    ],
    seo: {
...
<p><em>"The quality is exceptional. These hijabs drape beautifully and the colors are exactly as shown." - Aisha K.</em></p>`,
    ...
    options: ["Color Set"],
    variants: [
      { options: ["Classic (Black, Navy, Grey, Beige, White)"], price: "79.00", sku: "HJB-SET-CLS", inventoryQuantity: 25 },
      { options: ["Earth Tones (Brown, Olive, Rust, Cream, Taupe)"], price: "79.00", sku: "HJB-SET-ERT", inventoryQuantity: 20 },
      { options: ["Pastel (Pink, Lavender, Mint, Peach, Sky Blue)"], price: "79.00", sku: "HJB-SET-PST", inventoryQuantity: 18 },
    ],
    seo: {
...
<p><em>"Finally a burkini that looks good and performs well in water. I can swim laps comfortably!" - Fatima M.</em></p>`,
    ...
    options: ["Size", "Color"],
    variants: [
      { options: ["S", "Black"], price: "145.00", sku: "BRK-BLK-S", inventoryQuantity: 12 },
      { options: ["M", "Black"], price: "145.00", sku: "BRK-BLK-M", inventoryQuantity: 15 },
      { options: ["L", "Black"], price: "145.00", sku: "BRK-BLK-L", inventoryQuantity: 14 },
      { options: ["XL", "Black"], price: "145.00", sku: "BRK-BLK-XL", inventoryQuantity: 10 },
      { options: ["2XL", "Black"], price: "145.00", sku: "BRK-BLK-2XL", inventoryQuantity: 8 },
      { options: ["S", "Navy"], price: "145.00", sku: "BRK-NVY-S", inventoryQuantity: 10 },
      { options: ["M", "Navy"], price: "145.00", sku: "BRK-NVY-M", inventoryQuantity: 12 },
      { options: ["L", "Navy"], price: "145.00", sku: "BRK-NVY-L", inventoryQuantity: 11 },
    ],
    seo: {
...
<p><em>"Wore this to my sister's wedding and received so many compliments. The quality is exceptional!" - Layla R.</em></p>`,
    ...
    options: ["Size", "Color"],
    variants: [
      { options: ["S", "Emerald Green"], price: "299.00", sku: "KFT-EMR-S", inventoryQuantity: 5 },
      { options: ["M", "Emerald Green"], price: "299.00", sku: "KFT-EMR-M", inventoryQuantity: 7 },
      { options: ["L", "Emerald Green"], price: "299.00", sku: "KFT-EMR-L", inventoryQuantity: 6 },
      { options: ["S", "Royal Blue"], price: "299.00", sku: "KFT-RBL-S", inventoryQuantity: 4 },
      { options: ["M", "Royal Blue"], price: "299.00", sku: "KFT-RBL-M", inventoryQuantity: 6 },
      { options: ["L", "Royal Blue"], price: "299.00", sku: "KFT-RBL-L", inventoryQuantity: 5 },
      { options: ["M", "Burgundy"], price: "299.00", sku: "KFT-BRG-M", inventoryQuantity: 8 },
      { options: ["L", "Burgundy"], price: "299.00", sku: "KFT-BRG-L", inventoryQuantity: 7 },
    ],
    seo: {
...
<p><em>"The fabric is amazing - keeps me cool during HIIT workouts. Highly recommend!" - Nadia A.</em></p>`,
    ...
    options: ["Size", "Color"],
    variants: [
      { options: ["S", "Black"], price: "129.00", sku: "ACT-BLK-S", inventoryQuantity: 20 },
      { options: ["M", "Black"], price: "129.00", sku: "ACT-BLK-M", inventoryQuantity: 25 },
      { options: ["L", "Black"], price: "129.00", sku: "ACT-BLK-L", inventoryQuantity: 22 },
      { options: ["XL", "Black"], price: "129.00", sku: "ACT-BLK-XL", inventoryQuantity: 18 },
      { options: ["S", "Grey"], price: "129.00", sku: "ACT-GRY-S", inventoryQuantity: 15 },
      { options: ["M", "Grey"], price: "129.00", sku: "ACT-GRY-M", inventoryQuantity: 20 },
      { options: ["L", "Grey"], price: "129.00", sku: "ACT-GRY-L", inventoryQuantity: 18 },
      { options: ["S", "Navy"], price: "129.00", sku: "ACT-NVY-S", inventoryQuantity: 12 },
      { options: ["M", "Navy"], price: "129.00", sku: "ACT-NVY-M", inventoryQuantity: 15 },
    ],
    seo: {
...
<p><em>"I wear this for every prayer. It's so comfortable and easy to put on quickly. The fabric is beautiful and drapes nicely." - Khadija T.</em></p>`,
    ...
    options: ["Color"],
    variants: [
      { options: ["Black"], price: "89.00", sku: "JLB-BLK", inventoryQuantity: 30 },
      { options: ["Navy Blue"], price: "89.00", sku: "JLB-NVY", inventoryQuantity: 25 },
      { options: ["Coffee Brown"], price: "89.00", sku: "JLB-COF", inventoryQuantity: 20 },
      { options: ["Dark Grey"], price: "89.00", sku: "JLB-GRY", inventoryQuantity: 22 },
    ],
    seo: {
...
<p><em>"The best niqab I've worn. The breathing panels make such a difference, especially in summer." - Anonymous</em></p>`,
    ...
    options: ["Color"],
    variants: [
      { options: ["Black"], price: "45.00", sku: "NQB-BLK", inventoryQuantity: 40 },
      { options: ["Navy"], price: "45.00", sku: "NQB-NVY", inventoryQuantity: 35 },
      { options: ["Dark Grey"], price: "45.00", sku: "NQB-GRY", inventoryQuantity: 30 },
    ],
    seo: {
...
<p><em>"This dress is gorgeous! The print is beautiful and I get compliments every time I wear it. Very comfortable for all-day wear." - Maryam F.</em></p>`,
    ...
    options: ["Size", "Print"],
    variants: [
      { options: ["S", "Rose Garden"], price: "119.00", sku: "MXD-RSE-S", inventoryQuantity: 12 },
      { options: ["M", "Rose Garden"], price: "119.00", sku: "MXD-RSE-M", inventoryQuantity: 15 },
      { options: ["L", "Rose Garden"], price: "119.00", sku: "MXD-RSE-L", inventoryQuantity: 14 },
      { options: ["S", "Midnight Bloom"], price: "119.00", sku: "MXD-BLM-S", inventoryQuantity: 10 },
      { options: ["M", "Midnight Bloom"], price: "119.00", sku: "MXD-BLM-M", inventoryQuantity: 12 },
      { options: ["L", "Midnight Bloom"], price: "119.00", sku: "MXD-BLM-L", inventoryQuantity: 11 },
      { options: ["S", "Autumn Leaves"], price: "119.00", sku: "MXD-ATM-S", inventoryQuantity: 8 },
      { options: ["M", "Autumn Leaves"], price: "119.00", sku: "MXD-ATM-M", inventoryQuantity: 10 },
    ],
    seo: {
...
<p><em>"My daughter loves wearing her 'special outfit' to the mosque. The fabric is soft and she can play comfortably." - Parent Review</em></p>`,
    ...
    options: ["Size", "Color"],
    variants: [
      { options: ["2-3 Years", "Pink"], price: "69.00", sku: "KDS-PNK-2T", inventoryQuantity: 10 },
      { options: ["4-5 Years", "Pink"], price: "69.00", sku: "KDS-PNK-4T", inventoryQuantity: 12 },
      { options: ["6-7 Years", "Pink"], price: "69.00", sku: "KDS-PNK-6T", inventoryQuantity: 10 },
      { options: ["2-3 Years", "Lavender"], price: "69.00", sku: "KDS-LAV-2T", inventoryQuantity: 8 },
      { options: ["4-5 Years", "Lavender"], price: "69.00", sku: "KDS-LAV-4T", inventoryQuantity: 10 },
      { options: ["6-7 Years", "Lavender"], price: "69.00", sku: "KDS-LAV-6T", inventoryQuantity: 9 },
      { options: ["8-9 Years", "Mint Green"], price: "69.00", sku: "KDS-MNT-8T", inventoryQuantity: 7 },
      { options: ["10-12 Years", "Mint Green"], price: "69.00", sku: "KDS-MNT-10T", inventoryQuantity: 6 },
    ],
    seo: {
...
<p><em>"Excellent quality thobe. The fabric is substantial but breathable. Fits perfectly according to the size guide." - Ahmed K.</em></p>`,
    ...
    options: ["Size"],
    variants: [
      { options: ["52 (Small)"], price: "159.00", sku: "THB-52", inventoryQuantity: 15 },
      { options: ["54 (Medium)"], price: "159.00", sku: "THB-54", inventoryQuantity: 20 },
      { options: ["56 (Large)"], price: "159.00", sku: "THB-56", inventoryQuantity: 18 },
      { options: ["58 (XL)"], price: "159.00", sku: "THB-58", inventoryQuantity: 15 },
      { options: ["60 (2XL)"], price: "159.00", sku: "THB-60", inventoryQuantity: 12 },
    ],
    seo: {
...
<p><em>"This prayer mat is so comfortable, my knees don't hurt anymore during long prayers. The quality is excellent." - Yusuf M.</em></p>`,
    ...
    options: ["Color"],
    variants: [
      { options: ["Midnight Blue"], price: "49.00", sku: "RUG-BLU", inventoryQuantity: 30 },
      { options: ["Forest Green"], price: "49.00", sku: "RUG-GRN", inventoryQuantity: 25 },
      { options: ["Deep Burgundy"], price: "49.00", sku: "RUG-BUR", inventoryQuantity: 28 },
      { options: ["Royal Purple"], price: "49.00", sku: "RUG-PUR", inventoryQuantity: 22 },
      { options: ["Classic Red"], price: "49.00", sku: "RUG-RED", inventoryQuantity: 20 },
    ],
    seo: {
...
<p><em>"Bought this as a gift for my father and he loves it. The beads are smooth and the quality is outstanding." - Omar S.</em></p>`,
    ...
    options: ["Bead Color"],
    variants: [
      { options: ["Clear Crystal"], price: "35.00", sku: "TSB-CLR", inventoryQuantity: 40 },
      { options: ["Amber Crystal"], price: "35.00", sku: "TSB-AMB", inventoryQuantity: 35 },
      { options: ["Black Onyx"], price: "39.00", sku: "TSB-BLK", inventoryQuantity: 30 },
      { options: ["Rose Quartz"], price: "39.00", sku: "TSB-ROS", inventoryQuantity: 28 },
      { options: ["Turquoise Blue"], price: "39.00", sku: "TSB-TUR", inventoryQuantity: 32 },
    ],
    seo: {
...
<p><em>"This fanoos is absolutely beautiful! It creates such a warm atmosphere during Ramadan. My kids love it." - Layla H.</em></p>`,
    ...
    options: ["Color"],
    variants: [
      { options: ["Gold & Multicolor"], price: "59.00", sku: "FNS-GLD", inventoryQuantity: 25 },
      { options: ["Silver & Blue"], price: "59.00", sku: "FNS-SLV", inventoryQuantity: 20 },
      { options: ["Bronze & Amber"], price: "59.00", sku: "FNS-BRZ", inventoryQuantity: 18 },
    ],
    seo: {
...
<p><em>"The best dates I've ever tasted! Soft, sweet, and absolutely delicious. Will definitely order again." - Fatima A.</em></p>`,
    ...
    options: ["Grade"],
    variants: [
      { options: ["Premium (1kg)"], price: "49.00", sku: "DAT-PRM-1KG", inventoryQuantity: 50 },
      { options: ["Jumbo (1kg)"], price: "69.00", sku: "DAT-JUM-1KG", inventoryQuantity: 35 },
      { options: ["Mixed Variety (1.5kg)"], price: "89.00", sku: "DAT-MIX-15KG", inventoryQuantity: 25 },
    ],
    seo: {
...
<p><em>"Absolutely gorgeous! The calligraphy is elegant and the quality is museum-grade. Everyone who visits comments on it." - Amina R.</em></p>`,
    ...
    variants: [
      { options: ["50x70cm", "Gold Frame"], price: "89.00", sku: "ART-50-GLD", inventoryQuantity: 15 },
      { options: ["50x70cm", "Black Frame"], price: "89.00", sku: "ART-50-BLK", inventoryQuantity: 15 },
      { options: ["70x100cm", "Gold Frame"], price: "129.00", sku: "ART-70-GLD", inventoryQuantity: 10 },
      { options: ["70x100cm", "Black Frame"], price: "129.00", sku: "ART-70-BLK", inventoryQuantity: 10 },
      { options: ["70x100cm", "White Frame"], price: "129.00", sku: "ART-70-WHT", inventoryQuantity: 8 },
    ],
    seo: {
...
<p><em>"Beautiful craftsmanship! The wood grain is lovely and the carving is intricate. Makes my daily reading much more comfortable." - Ibrahim K.</em></p>`,
    ...
    options: ["Wood Type"],
    variants: [
      { options: ["Sheesham Wood"], price: "75.00", sku: "REH-SHE", inventoryQuantity: 20 },
      { options: ["Walnut Wood"], price: "89.00", sku: "REH-WAL", inventoryQuantity: 15 },
      { options: ["Rosewood"], price: "95.00", sku: "REH-ROS", inventoryQuantity: 12 },
    ],
    seo: {
...
// GraphQL mutation for publishing product
  ...
  for (let i = 0; i < richProducts.length; i++) {
    ...
    try {
      ...
      if (data?.data?.productCreate?.userErrors?.length > 0) {
        const errors = data.data.productCreate.userErrors.map((e: any) => e.message).join(", ");
        results.failed.push(product.title);
        results.errors.push(`${product.title}: ${errors}`);
      } else {
...
export default function SeedProductsPage() {
  const { productCount, products } = useLoaderData<typeof loader>();
  const fetcher = useFetcher<typeof action>();

  const isSubmitting = fetcher.state === "submitting";
  const isComplete = fetcher.state === "idle" && fetcher.data;

  return (
    <Page
      backAction={{ content: "Dashboard", url: "/app" }}
      title="Seed Rich Content Products"
    >
      <TitleBar title="Seed Products for Testing" />
      <BlockStack gap="500">
        <Layout>
          <Layout.Section>
            <Card>
              <BlockStack gap="400">
                <Text as="h2" variant="headingMd">
                  Create {productCount} Rich Content Products
                </Text>
                <Text as="p" variant="bodyMd" tone="subdued">
                  This will create multiple products with rich content (HTML descriptions, 
                  SEO fields, tags, variants) to test the RTL Storefront app translation features.
                </Text>
                
                <Box padding="400" background="bg-surface-secondary" borderRadius="200">
                  <BlockStack gap="300">
                    <Text as="h3" variant="headingSm">Products to be created:</Text>
                    <List>
                      {products.map((p, i) => (
                        <List.Item key={i}>
                ...
                {isComplete && fetcher.data && (
                  <BlockStack gap="400">
                    {fetcher.data.success > 0 && (
                      <Banner title={`Successfully created ${fetcher.data.success} products`} tone="success">
                        <List>
                          {fetcher.data.createdProducts.map((title: string, i: number) => (
                            <List.Item key={i}>{title}</List.Item>
                          ))}
                        </List>
                      </Banner>
                    )}
                    ...
                    {fetcher.data.failed > 0 && (
                      <Banner title={`Failed to create ${fetcher.data.failed} products`} tone="critical">
                        <List>
                          {fetcher.data.errors.map((error: string, i: number) => (
                ...
                <InlineStack align="end" gap="300">
                  <Button url="/app/translate">
                    Go to Translate
                  </Button>
                  <fetcher.Form method="POST">
                    <input type="hidden" name="intent" value="seed-products" />
                    <Button
                      variant="primary"
                      loading={isSubmitting}
                      disabled={isSubmitting || (isComplete && fetcher.data?.success > 0)}
                    >
                      {isSubmitting 
                        ? "Creating Products..." 
                        : isComplete && fetcher.data?.success > 0
                          ? "Products Created"
                          : "Create All Products"
                      }
                    </Button>
          ...
          <Layout.Section variant="oneThird">
            <Card>
              <BlockStack gap="400">
                <Text as="h2" variant="headingMd">Product Features</Text>
                <List>
                  <List.Item>Rich HTML descriptions</List.Item>
                  <List.Item>SEO title & meta description</List.Item>
                  <List.Item>Multiple product tags</List.Item>
                  <List.Item>Multiple variants with SKUs</List.Item>
                  <List.Item>Inventory quantities</List.Item>
                  <List.Item>Product type & vendor</List.Item>
                </List>
                
                <Text as="h3" variant="headingSm">Categories Included:</Text>
                <List>
                  <List.Item>Modest Fashion (Abayas, Hijabs)</List.Item>
                  <List.Item>Islamic Swimwear (Burkinis)</List.Item>
                  <List.Item>Evening Wear (Kaftans)</List.Item>
                  <List.Item>Sportswear & Activewear</List.Item>
                  <List.Item>Prayer Wear (Jilbabs)</List.Item>
                  <List.Item>Children's Clothing</List.Item>
                  <List.Item>Men's Islamic Clothing</List.Item>
                  <List.Item>Islamic Accessories</List.Item>
                  <List.Item>Home Decor & Art</List.Item>
                  <List.Item>Ramadan Items</List.Item>
                </List>
              </BlockStack>
            </Card>
          </Layout.Section>
