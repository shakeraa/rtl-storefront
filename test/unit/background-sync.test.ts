...
describe("background-sync", () => {
  ...
  describe("getRetryDelay", () => {
    ...
    it("applies exponential backoff", () => {
      ...
      // Each delay should be roughly 2x the previous (with jitter variance)
      expect(delay2).toBeGreaterThan(delay1 * 1.4); // Allow for jitter
      expect(delay3).toBeGreaterThan(delay2 * 1.4);
    });
