...
describe('Measurement Units Service', () => {
  ...
  describe('Format Measurement', () => {
    ...
    it('formats measurement in Arabic (RTL)', () => {
      ...
      // Arabic puts unit first for RTL
  ...
  describe('Format Number', () => {
    ...
    it('formats number in Hebrew', () => {
      ...
      // Hebrew uses standard numerals with RTL
  ...
  describe('Compare Measurements', () => {
    ...
    it('compares different units after conversion', () => {
      ...
      // 12 inches = 30.48 cm, so slightly larger than 30 cm
      expect(result).toBeGreaterThan(0);
    });
  ...
  describe('Calculate Percentage Difference', () => {
    ...
    it('handles different units', () => {
      ...
      // 12 inches vs 30 cm (which is ~11.81 inches)
      expect(result).toBeGreaterThan(0);
    });
  ...
  describe('Complete Workflow', () => {
    it('handles full conversion and formatting workflow', () => {
      // Start with imperial, convert to metric, format in Arabic
    ...
    it('handles product dimensions workflow', () => {
      // Convert product dimensions from cm to inches for US market
      const dimensions = {
      ...
      // Format for display
      const formattedWidth = formatMeasurement(
        dimensions.width.value,
        'in',
        'en',
        { useSymbol: true, decimals: 1 }
      );
