...
describe('Mailchimp Integration Service', () => {
  ...
  describe('Merge Tag Extraction', () => {
    ...
    it('should extract social share merge tags', () => {
      const template = `
        <a href="*|TWITTER:FULLURL|*">Tweet</a>
        <a href="*|FACEBOOK:FULLURL|*">Share</a>
      `;
      const tags = extractMergeTags(template);
  ...
  describe('Template Management', () => {
    ...
    it('should get templates by locale', () => {
      ...
      expect(arabicTemplates[0].name).toBe('Arabic Template');
    });
    ...
    it('should get templates by type', () => {
      ...
      expect(automationTemplates[0].name).toBe('Automation Template');
    });
  ...
  describe('Campaign Translation', () => {
    it('should translate campaign content and subject', async () => {
      const campaign: MailchimpCampaign = {
        ...
        content: '<h1>Hello *|FNAME|*!</h1><p>Welcome to our store.</p>',
        status: 'draft',
      };
    ...
    it('should preserve campaign metadata', async () => {
      ...
      expect(result.campaign.name).toBe('Welcome Campaign');
      expect(result.campaign.fromName).toBe('Store Team');
  ...
  describe('Automation Translation', () => {
    it('should translate automation email', async () => {
      const email = {
        ...
        name: 'Welcome Email',
        subject: 'Welcome!',
        content: '<p>Hello *|FNAME|*!</p>',
        position: 1,
        delay: { amount: 1, type: 'day' as const },
      };
