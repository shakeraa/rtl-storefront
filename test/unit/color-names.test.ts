...
describe('Color Names Localization Service - T0319', () => {
  ...
  describe('searchColors', () => {
    ...
    it('should handle partial matches', () => {
      const results = searchColors('blue', 'en');
      expect(results.some(r => r.key === 'blue')).toBe(true);
      expect(results.some(r => r.key === 'navy')).toBe(true);
    });
  ...
  describe('Color Data Structure', () => {
    it('should have all colors defined in all locales', () => {
      ...
      // All locales should have the same color keys
