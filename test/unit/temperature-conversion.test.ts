...
describe('Temperature Conversion Service', () => {
  describe('convertTemperature', () => {
    ...
    it('converts Celsius to Kelvin correctly', () => {
      ...
      expect(convertTemperature(-100, 'celsius', 'kelvin')).toBeCloseTo(173.15, 2);
    });
    ...
    it('converts Kelvin to Celsius correctly', () => {
      ...
      expect(convertTemperature(173.15, 'kelvin', 'celsius')).toBeCloseTo(-100, 2);
    });
  ...
  describe('formatTemperature', () => {
    ...
    it('places unit before number for Arabic locale (RTL)', () => {
      ...
      expect(formatted).toContain('°C');
      // Arabic locale uses Arabic numerals (٢٥) instead of Latin numerals (25)
