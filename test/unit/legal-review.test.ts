...
describe('Legal Review - validateLegalTerminology', () => {
  ...
  test('should detect problematic terms in Arabic', () => {
    const text = 'نضمن هذا المنتج إلى الأبد بدون قيود.';
    const result = validateLegalTerminology(text, 'ar');
...
describe('Legal Review - checkRequiredPhrases', () => {
  ...
  test('should validate terms of service with all required phrases', () => {
    const text = 'These Terms of Service govern your use of our website. By accessing our services, you agree to be bound by these terms. We reserve the right to modify these terms at any time.';
    const result = checkRequiredPhrases(text, 'en', 'terms_of_service');
  ...
  test('should validate privacy policy with required phrases', () => {
    const text = 'This Privacy Policy explains how we collect, use, and protect your personal data. We are committed to protecting your privacy. You have the right to access and delete your personal information.';
    const result = checkRequiredPhrases(text, 'en', 'privacy_policy');
    expect(result.isComplete).toBe(true);
  });
...
describe('Legal Review - Integration Tests', () => {
  test('should perform complete legal review for e-commerce terms', () => {
    const text = 'Terms of Service govern your use. By accessing, you agree. We reserve the right to modify terms.';
